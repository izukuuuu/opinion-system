<template>
  <section class="card-surface space-y-6 p-6">
    <header class="flex flex-wrap items-center justify-between gap-4">
      <div>
        <p class="text-xs font-semibold uppercase tracking-[0.4em] text-slate-400">数据库</p>
      ...
      >
        <div class="flex flex-col gap-2">
          <div class="flex flex-wrap items-center gap-2">
            <h3 class="text-base font-semibold text-slate-900">{{ connection.name }}</h3>
    ...
    >
      ...
      <form class="space-y-4" @submit.prevent>
        ...
        <button type="submit" class="hidden" aria-hidden="true">隐藏提交按钮</button>
      </form>
    </AppModal>
  </section>
</template>
