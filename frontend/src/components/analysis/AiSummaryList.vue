<template>
  <div class="grid gap-2.5 lg:grid-cols-2">
    <article
      v-for="item in items"
      :key="item.id"
      class="flex h-full flex-col rounded-2xl border border-soft bg-surface-muted p-3 transition hover:border-brand-soft"
    >
      ...
      <p class="mt-2 whitespace-pre-line text-sm leading-relaxed text-secondary">
